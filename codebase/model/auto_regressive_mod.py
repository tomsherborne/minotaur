...
@SeqDecoder.register("auto_regressive_seq_decoder_mod")
class AutoRegressiveModSeqDecoder(SeqDecoder):
    """
    ...
    def forward(
        ...
        # Only run predictions under test for now. Multitask validation is too expensive
