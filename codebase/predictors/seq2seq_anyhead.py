...
from codebase.data import PretrainedTransformerSeq2SeqPairedDatasetReader
...
class Seq2SeqAnyHeadPredictor(Predictor):
    ...
    def _json_to_instance_multihead(self, json_dict: JsonDict) -> Instance:
        task = "inner"
        tti_args = (json_dict["source"], None, None, None, json_dict['source_lang'])
    ...
    def _json_to_instance_single(self, json_dict: JsonDict) -> Instance:
        ...
        """
        tti_args = (json_dict["source"], None, None, None, json_dict['source_lang'])
        if isinstance(self._dataset_reader, PretrainedTransformerSeq2SeqPairedDatasetReader):
