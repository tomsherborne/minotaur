...
EXP_ROOT = os.environ.get("EXP_ROOT", f"/home/{os.environ['USER']}/sp/struct")

VALID_MBART50_MODELS = [
    "facebook/mbart-large-50-many-to-many-mmt", 
    "big/mbart-large-50-many-to-many-mmt", 
    f"{EXP_ROOT}/big/mbart-large-50-many-to-many-mmt"
    "./big/mbart-large-50-many-to-many-mmt"
]

VALID_MBART_MODELS = ["facebook/mbart-large-cc25"]
MASK_SYMBOL = "<mask>"
# Lang2Idx maps a locale to a label. Two scenarios: lang selection (0-7 labels) or binary EN/!EN (0-1 labels)
LANG2IDX = {"en_XX": torch.LongTensor([0]), "de_DE": torch.LongTensor([1]), "zh_CN": torch.LongTensor([2]),
            ...
            "id_XX": torch.LongTensor([6]), "not_en_XX": torch.LongTensor([1])}
...
class PretrainedTransformerSeq2SeqPairedDatasetReader(DatasetReader):
    ...
    def text_to_instance(
        ...
        lang_field = TensorField(LANG2IDX.get(self._validator(source_lang), DEFAULT_LANGIDX))
...
class LanguageFormatter:
    ...
    def __init__(self, valid_langs: List):
        ...
        self._lang2iso_map = {"en": "en_XX", "zh_cn": "zh_CN", "zh": "zh_CN", "pt": "pt_XX",
                              "fr": "fr_XX", "de": "de_DE", "es": "es_XX", "id": "id_ID"}
        self._drop_pt = False
